package com.kumar.childdictionary

import android.view.LayoutInflater
import android.view.View
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.kumar.childdictionary.databinding.MeaningRecyclerRowBinding
    ...
    class MeaningViewHolder(private val binding: MeaningRecyclerRowBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(meaning: Meaning){
            ...
            if (meaning.synonyms.isEmpty()){
                binding.synonymsTextviewTitle.visibility = View.GONE
                binding.synonymsTextview.visibility = View.GONE
            }else{
                binding.synonymsTextviewTitle.visibility = View.VISIBLE
            ...
            if (meaning.antonyms.isEmpty()){
                binding.antonymsTextviewTitle.visibility = View.GONE
                binding.antonymsTextview.visibility = View.GONE
            }else{
                binding.antonymsTextviewTitle.visibility = View.VISIBLE
